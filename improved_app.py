...
class FolderSplitRecommender:
    ...
    def prioritize_folders(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for _, user_row in self.users_exceeding.iterrows():
                ...
                # FIXED: Calculate files to move as the difference between before and after split
                files_to_move = total_file_count - remaining_files
                recommendations['total_recommended_moves'] = int(files_to_move)
                ...
                logger.info(f"Total recommended moves: {files_to_move:,}")
                ...
                st.write(f"Total recommended moves: {files_to_move:,}")
    ...
    def get_summary_table(self) -> pd.DataFrame:
        ...
        try:
            ...
            for user_email, user_recs in self.recommendations.items():
                ...
                # FIXED: Calculate files to move as the difference between before and after split
                files_to_move = user_recs['total_file_count'] - final_count
    ...
    def get_folder_splits_table(self) -> pd.DataFrame:
        """
        Create a detailed table of all recommended folder splits.
        
        Returns:
            DataFrame with detailed information about each folder split
        """
        try:
            folder_splits_data = []
            ...
            return pd.DataFrame(folder_splits_data)
...
def main():
    ...
    **Improvements in this version:**
    ...
    4. Correctly calculates files to move as the difference between before and after split
...
def display_results():
    ...
    for user_email, user_recs in recommendations.items():
        ...
        files_to_move = user_recs['total_file_count'] - user_recs['final_file_count']
